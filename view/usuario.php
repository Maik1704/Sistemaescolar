...
<div class="page-content">
  ...
  include "../controller/controlador_modificar.php";
  include "../controller/controladorelminarusuario.php";
  $sql = $conexion->query(" SELECT * from usuario ")
    ?>

  <a href="registrousuario.php" class="btn btn-primary btn-rounded mb-2 "> <i class="fa-solid fa-user-plus"></i> &nbsp;
    Registrar</a>
        ...
        <tr>
          ...
          <td>
            <a href="" data-toggle="modal" data-target="#exampleModal<?= $datos->id_usuario ?>"
              class="btn btn-warning-outline btn-sm"><i class="fa-solid fa-pen"></i></a>
            <a href="usuario.php?id=<?= $datos->id_usuario ?>" onclick="advertencia(event)" class="btn btn-danger-outline">

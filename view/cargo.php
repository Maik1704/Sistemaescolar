...
include "../controller/controlador_modificarcargo.php";

include "../controller/controlador_eliminarcargo.php";

  $sql=$conexion->query(" SELECT * from cargo ")
  ?>

  <a href="registrocargo.php" class="btn btn-primary btn-rounded mb-2 "> <i class="fa-solid fa-user-plus"></i> &nbsp; Registrar</a>
  ...
  <tbody>
    ...
    while ($datos = $sql->fetch_object()) {?>
      <tr>
        ...
        <td>
          <a href="" data-toggle="modal" data-target="#exampleModal<?= $datos->id_cargo ?>" class="btn btn-warning-outline btn-sm"><i class="fa-solid fa-pen"></i></a>
          <a href="cargo.php?id=<?=$datos->id_cargo?>" onclick="advertencia(event)" class="btn btn-danger-outline"> <i class="fa-solid fa-trash-can"></i> </a>
        </td>
      </tr>

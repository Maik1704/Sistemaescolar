...
include "../controller/controlador_modificarpersonal.php";
include "../controller/controlador_eliminarpersonal.php";
...
FROM
  ...
  <a href="registropersonal.php" class="btn btn-primary btn-rounded mb-2 "> <i class="fa-solid fa-user-plus"></i> &nbsp; Registrar</a>
  ...
  <tbody>
    ...
    while ($datos = $sql->fetch_object()) {?>
      <tr>
        ...
        <td>
          <a href="" data-toggle="modal" data-target="#exampleModal<?= $datos->id_empleado ?>" class="btn btn-warning-outline btn-sm"><i class="fa-solid fa-pen"></i></a>
          <a href="personal.php?id=<?=$datos->id_empleado?>" onclick="advertencia(event)" class="btn btn-danger-outline"> <i class="fa-solid fa-trash-can"></i> </a>
        </td>
      </tr>
